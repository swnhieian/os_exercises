...
## 问题1： 
根据[sfs文件系统的状态变化信息](https://github.com/chyyuu/ucore_lab/blob/master/related_info/lab8/sfs_states.txt)，给出具体的文件相关操作内容.
> mkdir("/g");  
creat("/q");  
creat("/u");  
link("/u", "/x");  
...
> 代码见https://github.com/swnhieian/os_exercises/blob/master/all/sfs-homework.py
