...
分别运行两个程序比较其时间，结果如下：
```
moocos-> gcc -O0 -o good testfast.c
[~/Desktop]
moocos-> time ./good
...
sys 0m0.014s
[~/Desktop]
moocos-> gcc -O0 -o bad testslow.c
[~/Desktop]
moocos-> time ./bad
10485760 count computing over!
real  0m0.447s
...
> 
答案：
代码见文件[04-1-spoc-code/page.cpp](./04-1-spoc-code/page.cpp "page.cpp")  
数据见文件[04-1-spoc-code/memory.txt](./04-1-spoc-code/memory.txt "memory.txt")  
答案如下：
```
